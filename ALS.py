...
class ALS(object):
    ...
    """
    def __init__(self, k=10, lambda_ = 10, max_iter=10, tol=1e-5, print_iter=False):
        """
    ...
    def fit(self, ratings):
        ...
        for i in range(self._max_iter):
            ...
            self._update_proj()
            self._bias = np.append(self._bias, norm(self._data - self._proj, ord='fro'))
